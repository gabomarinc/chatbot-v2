...
Genera 2 opciones contrastantes pero útiles (ej: Una más orientado a cierre/ventas vs otra más orientada a asesoría/educación, o Formal vs Cercano).`;
    ...
    try {
        ...
        // ... (imports)
        import { addKnowledgeSource } from './knowledge'; // We'll need to add this import at top
        import { createAgent } from './dashboard'; // We'll need to add this import
        ...
        export async function createAgentFromWizard(data: {
            ...
            // 1. Create Base Agent
            // We reuse createAgent to handle permissions and basic setup
            // But we need to override systemPrompt with the personality one
            ...
            try {
                ...
                // Note: modify addKnowledgeSource to accept base64 string for PDF if needed or handle it here
                // The wizard sends: 
                // - WEB: source = url
                // - TEXT: source = text content
                // - PDF: source = base64 string (from FileReader in StepKnowledge)
                ...
                if (data.knowledge.type === 'WEB') {
                    ...
                    sourceData.crawlSubpages = true; // Default for wizard
                ...
                // 3. Create Channels
                // We need to create channel records for enabled ones
                ...
                // We can use prisma directly here as we are server-side
                ...
                // Optional: Delete agent if failed? Or leave it partial?
                // For now leave it partial so user doesn't lose data
                throw e;
            }
        }
