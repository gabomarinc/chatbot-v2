...
export const stripe = new Stripe(process.env.STRIPE_SECRET_KEY, {
    apiVersion: '2025-01-27.acacia' as any, // Bypass TS error for specific version string requirement by stripe sdk internally
    typescript: true,
});

export const PLAN_PRICE_IDS = {
    BASIC: process.env.STRIPE_PRICE_ID_BASIC || 'price_placeholder_basic',
...
export const getPlanFromPriceId = (priceId: string) => {
    if (priceId === PLAN_PRICE_IDS.BASIC) return 'BASIC';
